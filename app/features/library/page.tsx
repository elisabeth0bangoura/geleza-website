    ...
    <div>
      <div className="bg-gray-900 py-20 px-4">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="text-center mt-3 text-gray-50 text-lg">
            Read anything you want, anytime you want, anywhere you want. Powered
            by Geleza AI.
          </p>
          <a
            ...
            <div className=" lg:p-16 rounded-[4rem] space-y-6 md:flex flex-row-reverse md:gap-6 justify-center md:space-y-0 lg:items-center">
              ...
              <div className="md:7/12 lg:w-1/2">
                ...
                <p className="my-8 text-gray-600 ">
                  To begin, choose what you want to read, choose the topic, and
                  our in-app AI, Zeda, will write something unique for you to
                  read. The library always provide unique and different content
                  each and every time so you never have to read the same thing
                  twice, even under the same topic.
                </p>
                  ...
                  <div className="mt-8 flex gap-4 md:items-center">
                    ...
                    <div className="w-5/6">
                      ...
                      <p className="text-gray-500 ">
                        Content under the library is personalized for the
                        reader. Your name, country and other information may be
                        included in the content, to help you connect and relate
                        more to what you are reading.
                      </p>
                    </div>
                  </div>
                </div>
