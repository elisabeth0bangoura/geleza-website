          ...
          <div className=" lg:p-16 rounded-[4rem] space-y-6 md:flex flex-row-reverse md:gap-6 justify-center md:space-y-0 lg:items-center">
            ...
            <div className="md:7/12 lg:w-1/2">
              ...
              <p className="my-8 text-gray-600 ">
                Transform your writing experience with Zeda Writer, the A.I tool
        ...
        <div className="container relative m-auto px-6 text-gray-500 md:px-12">
          <div className="grid gap-6 md:mx-auto md:w-8/12 lg:w-full lg:grid-cols-3">
            <div className="hover:scale-105 transition-all duration-500 group space-y-6 border border-gray-100 rounded-3xl bg-white  px-8 py-12 text-center shadow-2xl shadow-gray-400 ">
              ...
              <p>
                Choose the type of the content you want to write. You can choose
            ...
            <div className="hover:scale-105 transition-all duration-500 group space-y-6 border border-gray-100  rounded-3xl bg-white  px-8 py-12 text-center shadow-2xl shadow-gray-400 ">
              <img
                ...
                loading="lazy"
              />
              <h3 className="text-2xl font-bold text-gray-800">Step 2</h3>
              <p>
                Choose the number of words, as well as the tone. The tone can be
                professional, friendly, angry, or anything else.
              </p>
