...
const TermsPage = () => {
  return (
    <div className="px-5 w-full mx-auto max-w-7xl py-20 prose prose-lg !text-dark prose-headings:text-dark">
      ...
      <p>Welcome to geleza.app!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Reavize's Website, located at www.geleza.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use geleza.app if you do not agree to
      ...
      <p>
        Unless otherwise stated, Reavize and/or its licensors own the
        intellectual property rights for all material on geleza.app. All
        intellectual property rights are reserved. You may access this from
        geleza.app for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from geleza.app</li>
        <li>Sell, rent or sub-license material from geleza.app</li>
      ...
      <p>
        ...
        Reavize does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Reavize,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Reavize shall not be liable for the
      ...
      <p>
        Reavize reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Reavize a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Reavize; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Reavize. Please include your name, your organization name,
      ...
      <p>
        No use of Reavize's logo or other artwork will be allowed for linking
