  ...
  return (
    <div className="bg-gray-800 w-full">
      <div className="w-full max-w-7xl mx-auto py-20 flex flex-col justify-center items-center px-5">
        ...
        <h1 className="mt-5 text-3xl md:text-6xl text-center font-black text-gray-50">
          Get a lot more <br /> for only{' '}
        ...
        <a
          className="btn bg-white text-black shadow-orange-700 font-normal mt-5 text-xl"
          href={CLASS_URL}
        >
          Start Learning Now
        </a>
